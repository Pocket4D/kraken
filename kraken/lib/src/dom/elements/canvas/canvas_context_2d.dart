...
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetDirection =
    Pointer.fromFunction(CanvasRenderingContext2D._setDirection);
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetFont =
    Pointer.fromFunction(CanvasRenderingContext2D._setFont);
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetFillStyle =
    Pointer.fromFunction(CanvasRenderingContext2D._setFillStyle);
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetStrokeStyle =
    Pointer.fromFunction(CanvasRenderingContext2D._setStrokeStyle);
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetLineCap =
    Pointer.fromFunction(CanvasRenderingContext2D._setLineCap);
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetLineDashOffset =
    Pointer.fromFunction(CanvasRenderingContext2D._setLineDashOffset);
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetLineJoin =
    Pointer.fromFunction(CanvasRenderingContext2D._setLineJoin);
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetLineWidth =
    Pointer.fromFunction(CanvasRenderingContext2D._setLineWidth);
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetMiterLimit =
    Pointer.fromFunction(CanvasRenderingContext2D._setMiterLimit);
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetTextAlign =
    Pointer.fromFunction(CanvasRenderingContext2D._setTextAlign);
final Pointer<NativeFunction<Native_RenderingContextSetProperty>> nativeSetTextBaseline =
    Pointer.fromFunction(CanvasRenderingContext2D._setTextBaseline);

final Pointer<NativeFunction<Native_RenderingContextArc>> nativeArc =
    Pointer.fromFunction(CanvasRenderingContext2D._arc);
final Pointer<NativeFunction<Native_RenderingContextArcTo>> nativeArcTo =
    Pointer.fromFunction(CanvasRenderingContext2D._arcTo);
final Pointer<NativeFunction<Native_RenderingContextFillRect>> nativeFillRect =
    Pointer.fromFunction(CanvasRenderingContext2D._fillRect);
final Pointer<NativeFunction<Native_RenderingContextBeginPath>> nativeBeginPath =
    Pointer.fromFunction(CanvasRenderingContext2D._beginPath);
final Pointer<NativeFunction<Native_RenderingContextBezierCurveTo>> nativeBezierCurveTo =
    Pointer.fromFunction(CanvasRenderingContext2D._bezierCurveTo);
final Pointer<NativeFunction<Native_RenderingContextClip>> nativeClip =
    Pointer.fromFunction(CanvasRenderingContext2D._clip);
final Pointer<NativeFunction<Native_RenderingContextClearRect>> nativeClearRect =
    Pointer.fromFunction(CanvasRenderingContext2D._clearRect);
final Pointer<NativeFunction<Native_RenderingContextClosePath>> nativeClosePath =
    Pointer.fromFunction(CanvasRenderingContext2D._closePath);
final Pointer<NativeFunction<Native_RenderingContextEllipse>> nativeEllipse =
    Pointer.fromFunction(CanvasRenderingContext2D._ellipse);
final Pointer<NativeFunction<Native_RenderingContextFill>> nativeFill =
    Pointer.fromFunction(CanvasRenderingContext2D._fill);
final Pointer<NativeFunction<Native_RenderingContextFillText>> nativeFillText =
    Pointer.fromFunction(CanvasRenderingContext2D._fillText);
final Pointer<NativeFunction<Native_RenderingContextLineTo>> nativeLineTo =
    Pointer.fromFunction(CanvasRenderingContext2D._lineTo);
final Pointer<NativeFunction<Native_RenderingContextMoveTo>> nativeMoveTo =
    Pointer.fromFunction(CanvasRenderingContext2D._moveTo);
final Pointer<NativeFunction<Native_RenderingContextQuadraticCurveTo>> nativeQuadraticCurveTo =
    Pointer.fromFunction(CanvasRenderingContext2D._quadraticCurveTo);
final Pointer<NativeFunction<Native_RenderingContextRect>> nativeRect =
    Pointer.fromFunction(CanvasRenderingContext2D._rect);
final Pointer<NativeFunction<Native_RenderingContextRestore>> nativeRestore =
    Pointer.fromFunction(CanvasRenderingContext2D._restore);
final Pointer<NativeFunction<Native_RenderingContextRotate>> nativeRotate =
    Pointer.fromFunction(CanvasRenderingContext2D._rotate);
final Pointer<NativeFunction<Native_RenderingContextResetTransform>> nativeResetTransform =
    Pointer.fromFunction(CanvasRenderingContext2D._resetTransform);
final Pointer<NativeFunction<Native_RenderingContextSave>> nativeSave =
    Pointer.fromFunction(CanvasRenderingContext2D._save);
final Pointer<NativeFunction<Native_RenderingContextScale>> nativeScale =
    Pointer.fromFunction(CanvasRenderingContext2D._scale);
final Pointer<NativeFunction<Native_RenderingContextStroke>> nativeStroke =
    Pointer.fromFunction(CanvasRenderingContext2D._stroke);
final Pointer<NativeFunction<Native_RenderingContextStrokeText>> nativeStrokeText =
    Pointer.fromFunction(CanvasRenderingContext2D._strokeText);
final Pointer<NativeFunction<Native_RenderingContextStrokeRect>> nativeStrokeRect =
    Pointer.fromFunction(CanvasRenderingContext2D._strokeRect);
final Pointer<NativeFunction<Native_RenderingContextSetTransform>> nativeSetTransform =
    Pointer.fromFunction(CanvasRenderingContext2D._setTransform);
final Pointer<NativeFunction<Native_RenderingContextTransform>> nativeTransform =
    Pointer.fromFunction(CanvasRenderingContext2D._transform);
final Pointer<NativeFunction<Native_RenderingContextTranslate>> nativeTranslate =
    Pointer.fromFunction(CanvasRenderingContext2D._translate);
...
class CanvasRenderingContext2D {
  ...
  CanvasRenderingContext2D()
      : nativeCanvasRenderingContext2D = calloc<NativeCanvasRenderingContext2D>() {
  ...
  static CanvasRenderingContext2D getCanvasRenderContext2DOfNativePtr(
      Pointer<NativeCanvasRenderingContext2D> nativePtr) {
    CanvasRenderingContext2D renderingContext = _nativeMap[nativePtr.address];
    assert(
        renderingContext != null, 'Can not get nativeRenderingContext2D from pointer: $nativePtr');
  ...
  static void _setDirection(
      Pointer<NativeCanvasRenderingContext2D> nativePtr, Pointer<NativeString> value) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
    canvasRenderingContext2D.direction = parseDirection(nativeStringToString(value));
  }

  static void _setFont(
      Pointer<NativeCanvasRenderingContext2D> nativePtr, Pointer<NativeString> value) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
  ...
  static void _setLineDashOffset(
      Pointer<NativeCanvasRenderingContext2D> nativePtr, Pointer<NativeString> value) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
  ...
  static void _arc(Pointer<NativeCanvasRenderingContext2D> nativePtr, double x, double y,
      double radius, double startAngle, double endAngle, double counterclockwise) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
    canvasRenderingContext2D.arc(x, y, radius, startAngle, endAngle,
        anticlockwise: counterclockwise == 1 ? true : false);
  }

  static void _arcTo(Pointer<NativeCanvasRenderingContext2D> nativePtr, double x1, double y1,
  ...
  static void _fillRect(Pointer<NativeCanvasRenderingContext2D> nativePtr, double x, double y,
  ...
  static void _clearRect(Pointer<NativeCanvasRenderingContext2D> nativePtr, double x, double y,
      double width, double height) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
  ...
  static void _strokeRect(Pointer<NativeCanvasRenderingContext2D> nativePtr, double x, double y,
      double width, double height) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
  ...
  static void _fillText(Pointer<NativeCanvasRenderingContext2D> nativePtr,
      Pointer<NativeString> text, double x, double y, double maxWidth) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
    if (!maxWidth.isNaN) {
  ...
  static void _strokeText(Pointer<NativeCanvasRenderingContext2D> nativePtr,
      Pointer<NativeString> text, double x, double y, double maxWidth) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
    if (!maxWidth.isNaN) {
  ...
  static void _bezierCurveTo(Pointer<NativeCanvasRenderingContext2D> nativePtr, double x1,
  ...
  static void _clip(
      Pointer<NativeCanvasRenderingContext2D> nativePtr, Pointer<NativeString> fillRule) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);

    PathFillType fillType =
        nativeStringToString(fillRule) == EVENODD ? PathFillType.evenOdd : PathFillType.nonZero;
  ...
  static void _ellipse(
    ...
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
    canvasRenderingContext2D.ellipse(x, y, radiusX, radiusY, rotation, startAngle, endAngle,
        anticlockwise: counterclockwise == 1 ? true : false);
  }
  ...
  static void _quadraticCurveTo(Pointer<NativeCanvasRenderingContext2D> nativePtr, double cpx,
      double cpy, double x, double y) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
  ...
  static void _setTransform(Pointer<NativeCanvasRenderingContext2D> nativePtr, double a, double b,
  ...
  static void _transform(Pointer<NativeCanvasRenderingContext2D> nativePtr, double a, double b,
      double c, double d, double e, double f) {
    CanvasRenderingContext2D canvasRenderingContext2D =
        getCanvasRenderContext2DOfNativePtr(nativePtr);
  ...
  TextStyle _getTextStyle(Color color, bool shouldStrokeText) {
    ...
    double fontSize =
        CSSLength.toDisplayPortValue(_fontProperties[FONT_SIZE] ?? '10px', viewportSize);
    var fontFamilyFallback =
        CSSText.parseFontFamilyFallback(_fontProperties[FONT_FAMILY] ?? 'sans-serif');
  ...
  void fillText(String text, double x, double y, {double maxWidth}) {
    addAction((Canvas canvas, Size size) {
      ...
      textPainter.paint(
          canvas, Offset(x, y - offsetToBaseline) - _getAlignOffset(textPainter.width));
    });
  }
