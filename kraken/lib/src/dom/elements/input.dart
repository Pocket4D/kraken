...
final Pointer<NativeFunction<GetInputWidth>> nativeGetInputWidth =
    Pointer.fromFunction(InputElement.getInputWidth, 0.0);
final Pointer<NativeFunction<GetInputHeight>> nativeGetInputHeight =
    Pointer.fromFunction(InputElement.getInputHeight, 0.0);
final Pointer<NativeFunction<InputElementMethodVoidCallback>> nativeInputMethodFocus =
    Pointer.fromFunction(InputElement.callMethodFocus);
final Pointer<NativeFunction<InputElementMethodVoidCallback>> nativeInputMethodBlur =
    Pointer.fromFunction(InputElement.callMethodBlur);
...
class InputElement extends Element implements TextInputClient, TickerProvider {
  ...
  InputElement(
    ...
    this.minLines = 1,
    this.maxLines = 1,
  }) : super(targetId, nativeInputElement.ref.nativeElement, elementManager,
            tagName: INPUT, defaultStyle: _defaultStyle, isIntrinsicBox: true) {
  ...
  void onSelectionChanged(
      TextSelection selection, RenderEditable renderObject, SelectionChangedCause cause) {
    TextEditingValue value = textSelectionDelegate.textEditingValue.copyWith(
        selection: renderObject.text == placeholderTextSpan ? blurSelection : selection,
  ...
  RenderObject createRenderObject() {
    ...
    double dy = renderStyle.height == null
        ...
        : (renderStyle.height -
                ...
                renderIntrinsic.renderStyle.borderBottom) /
            2;
...
class RenderOffsetBox extends RenderProxyBox {
  RenderOffsetBox({RenderBox child, Offset offset})
      : assert(offset != null),
        _offset = offset,
        super(child);
