...
class Event {
  ...
  Pointer toNative() {
    Pointer<NativeEvent> event = calloc<NativeEvent>();
  ...
  Map toJson() {
    ...
    return {'type': type, 'nativeEvent': nativeEvent.address};
  }
...
class GestureEvent extends Event {
  ...
  Pointer<NativeGestureEvent> toNative() {
    Pointer<NativeGestureEvent> nativeGestureEventPointer = calloc<NativeGestureEvent>();
...
class CustomEvent extends Event {
  ...
  Pointer<NativeCustomEvent> toNative() {
    Pointer<NativeCustomEvent> nativeCustomEventPointer = calloc<NativeCustomEvent>();
...
class InputEvent extends Event {
  ...
  Pointer<NativeInputEvent> toNative() {
    Pointer<NativeInputEvent> nativeInputEvent = calloc<NativeInputEvent>();
...
class MediaError extends Event {
  ...
  Pointer<NativeMediaErrorEvent> toNative() {
    Pointer<NativeMediaErrorEvent> nativeMediaError = calloc<NativeMediaErrorEvent>();
    Pointer<NativeEvent> nativeEvent = super.toNative().cast<NativeEvent>();
...
class MessageEvent extends Event {
  ...
  Pointer<NativeMessageEvent> toNative() {
    Pointer<NativeMessageEvent> messageEvent = calloc<NativeMessageEvent>();
    Pointer<NativeEvent> nativeEvent = super.toNative().cast<NativeEvent>();
...
class CloseEvent extends Event {
  ...
  Pointer<NativeCloseEvent> toNative() {
    Pointer<NativeCloseEvent> closeEvent = calloc<NativeCloseEvent>();
    Pointer<NativeEvent> nativeEvent = super.toNative().cast<NativeEvent>();
...
class IntersectionChangeEvent extends Event {
  ...
  Pointer<NativeIntersectionChangeEvent> toNative() {
    Pointer<NativeIntersectionChangeEvent> intersectionChangeEvent =
        calloc<NativeIntersectionChangeEvent>();
    Pointer<NativeEvent> nativeEvent = super.toNative().cast<NativeEvent>();
...
class TouchEvent extends Event {
  ...
  Pointer<NativeTouchEvent> toNative() {
    Pointer<NativeTouchEvent> touchEvent = calloc<NativeTouchEvent>();
...
class Touch {
  ...
  Pointer<NativeTouch> toNative() {
    Pointer<NativeTouch> nativeTouch = calloc<NativeTouch>();
...
class TouchList {
  ...
  Pointer<Pointer<NativeTouch>> toNative() {
    Pointer<Pointer<NativeTouch>> touchList =
        calloc<NativeTouch>(items.length).cast<Pointer<NativeTouch>>();
