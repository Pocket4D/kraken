...
mixin CSSTextMixin on RenderStyleBase {
  ...
  static TextStyle getTextStyle(Element parent) {
    ...
    Color color = parentRenderBoxModel != null
        ? parentRenderBoxModel.renderStyle.color
        : CSSText.getTextColor(parent.style);
    TextDecoration textDecorationLine = parentRenderBoxModel != null
        ? parentRenderBoxModel.renderStyle.textDecorationLine
        : CSSText.getTextDecorationLine(parent.style);
    Color textDecorationColor = parentRenderBoxModel != null
        ? parentRenderBoxModel.renderStyle.textDecorationColor
        : CSSText.getTextDecorationColor(parent.style);
    TextDecorationStyle textDecorationStyle = parentRenderBoxModel != null
        ? parentRenderBoxModel.renderStyle.textDecorationStyle
        : CSSText.getTextDecorationStyle(parent.style);
    FontWeight fontWeight = parentRenderBoxModel != null
        ? parentRenderBoxModel.renderStyle.fontWeight
        : CSSText.getFontWeight(parent.style);
    FontStyle fontStyle = parentRenderBoxModel != null
        ? parentRenderBoxModel.renderStyle.fontStyle
        : CSSText.getFontStyle(parent.style);
    double fontSize = parentRenderBoxModel != null
        ? parentRenderBoxModel.renderStyle.fontSize
        : CSSText.getFontSize(parent.style, viewportSize);
    double letterSpacing = parentRenderBoxModel != null
        ? parentRenderBoxModel.renderStyle.letterSpacing
        : CSSText.getLetterSpacing(parent.style, viewportSize);
    double wordSpacing = parentRenderBoxModel != null
        ? parentRenderBoxModel.renderStyle.wordSpacing
        : CSSText.getWordSpacing(parent.style, viewportSize);
    List<Shadow> textShadow = parentRenderBoxModel != null
        ? parentRenderBoxModel.renderStyle.textShadow
        : CSSText.getTextShadow(parent.style, viewportSize);
      ...
      for (int i = 0; i < values.length; i++) {
        ...
        switch (familyName) {
          ...
          case 'monospace':
            ...
            resolvedFamily.addAll(
                ['Courier', 'Courier New', 'DroidSansMono', 'Monaco', 'Heiti SC', 'Heiti TC']);
            break;
          case 'cursive':
            // Default cursive font in iOS and iPadOS: Snell Roundhand
            resolvedFamily
                .addAll(['Snell Roundhand', 'Apple Chancery', 'DancingScript', 'Comic Sans MS']);
            break;
          case 'fantasy':
