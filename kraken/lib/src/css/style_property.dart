...
class CSSStyleProperty {
  ...
  static void removeShorthandBorderRadius(CSSStyleDeclaration style) {
    ...
    if (style.contains(BORDER_BOTTOM_RIGHT_RADIUS))
      style.removeProperty(BORDER_BOTTOM_RIGHT_RADIUS);
  ...
  static void removeShorthandTransition(CSSStyleDeclaration style) {
    ...
    if (style.contains(TRANSITION_TIMING_FUNCTION))
  ...
  static void setShorthandBorder(
      Map<String, String> properties, String property, String shorthandValue) {
  ...
  static List<List<String>> getShadowValues(String property) {
    ...
    for (String shadow in shadows) {
      ...
      List<String> lengthValues = []..length = 4;
      int i = 0;
      ...
      for (String part in parts) {
        if (property == null && CSSTransition.isValidTransitionPropertyValue(part)) {
          ...
          duration = part;
            ...
            CSSTransition.isValidTransitionTimingFunctionValue(part)) {
          timingFuction = part;
