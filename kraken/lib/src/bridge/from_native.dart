...
Pointer<Uint16> _stringToUint16(String string) {
  ...
  final Pointer<Uint16> result = calloc<Uint16>(units.length);
...
Pointer<NativeString> stringToNativeString(String string) {
  assert(string != null);
  Pointer<NativeString> nativeString = calloc<NativeString>();
...
typedef NativeAsyncModuleCallback = Void Function(Pointer<JSCallbackContext> callbackContext,
    Int32 contextId, Pointer<NativeString> errmsg, Pointer<NativeString> json);
typedef DartAsyncModuleCallback = void Function(Pointer<JSCallbackContext> callbackContext,
    int contextId, Pointer<NativeString> errmsg, Pointer<NativeString> json);

typedef Native_InvokeModule = Pointer<NativeString> Function(
...
String invokeModule(Pointer<JSCallbackContext> callbackContext, int contextId, String moduleName,
    String method, String params, DartAsyncModuleCallback callback) {
  ...
  try {
    ...
    result = controller.module.moduleManager.invokeModule(moduleName, method,
        (params != null && params != '""') ? jsonDecode(params) : null, invokeModuleCallback);
  } catch (e, stack) {
    String errmsg = '$e\n$stack';
...
final Pointer<NativeFunction<Native_InvokeModule>> _nativeInvokeModule =
...
// Register setTimeout
typedef Native_SetTimeout = Int32 Function(Pointer<JSCallbackContext> callbackContext,
    Int32 contextId, Pointer<NativeFunction<NativeAsyncCallback>>, Int32);
...
typedef Native_SetInterval = Int32 Function(Pointer<JSCallbackContext> callbackContext,
    Int32 contextId, Pointer<NativeFunction<NativeAsyncCallback>>, Int32);
...
final Pointer<NativeFunction<Native_ClearTimeout>> _nativeClearTimeout =
    Pointer.fromFunction(_clearTimeout);

// Register requestAnimationFrame
typedef Native_RequestAnimationFrame = Int32 Function(Pointer<JSCallbackContext> callbackContext,
    Int32 contextId, Pointer<NativeFunction<NativeRAFAsyncCallback>>);
...
typedef NativeAsyncBlobCallback = Void Function(Pointer<JSCallbackContext> callbackContext,
    Int32 contextId, Pointer<Utf8>, Pointer<Uint8>, Int32);
...
void _toBlob(Pointer<JSCallbackContext> callbackContext, int contextId,
  ...
  controller.view.toImage(devicePixelRatio, id).then((Uint8List bytes) {
    Pointer<Uint8> bytePtr = calloc<Uint8>(bytes.length);
...
final Pointer<NativeFunction<Native_FlushUICommand>> _nativeFlushUICommand =
    Pointer.fromFunction(_flushUICommand);
...
final Pointer<NativeFunction<Native_InitWindow>> _nativeInitWindow =
    Pointer.fromFunction(_initWindow);
...
final Pointer<NativeFunction<Native_InitDocument>> _nativeInitDocument =
    Pointer.fromFunction(_initDocument);

typedef Native_Performance_GetEntries = Pointer<NativePerformanceEntryList> Function(
    Int32 contextId);
...
final Pointer<NativeFunction<Native_Performance_GetEntries>> _nativeGetEntries =
...
final Dart_RegisterDartMethods _registerDartMethods = nativeDynamicLibrary
    .lookup<NativeFunction<Native_RegisterDartMethods>>('registerDartMethods')
    .asFunction();

void registerDartMethodsToCpp() {
  Pointer<Uint64> bytes = calloc<Uint64>(_dartNativeMethods.length);
