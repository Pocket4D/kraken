...
class PerformanceTiming {
  ...
  Pointer<NativePerformanceEntryList> toNative() {
    Pointer<NativePerformanceEntryList> list = calloc<NativePerformanceEntryList>();
    ...
    for (int i = 0; i < byteLength; i += 3) {
      // data[i] = Pointer<Utf8>(entries[dataIndex].name).address;
    ...
    final Pointer<Uint64> bytes = calloc<Uint64>(byteLength);
